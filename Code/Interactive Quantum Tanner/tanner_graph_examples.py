...
def example_2_genus_comparison():
    ...
    for i, genus in enumerate(genus_values):
        ...
        ax2.set_title(f'Distance Bounds (g={genus})', fontsize=10)
...
def example_4_error_correction_simulation():
    ...
    ax1.set_title('Error Correction Performance', fontweight='bold')
    ...
    bars = ax2.bar(metric_names, metric_values, 
                  color=[seqCmap(0.3), altCmap(0.5), divCmap(0.7), seqCmap(0.8)],
                  alpha=0.7)
    ax2.set_title('Graph Properties', fontweight='bold')
...
def example_5_performance_analysis():
    ...
    ax1.set_ylabel('Distance Bound')
    ax1.set_title('Distance vs Genus', fontweight='bold')
    ax1.legend()
    ax1.grid(True, alpha=0.3)
    ...
    ax2.set_title('Edge Density', fontweight='bold')
    ...
    ax3.set_xlabel('Genus')
    ax3.set_ylabel('Number of Data Qubits')
    ax3.set_title('Clustering Coefficient', fontweight='bold')
    ...
    ax4.set_ylabel('Distance Bound')
    ax4.set_title('Distance vs Density Trade-off', fontweight='bold')
    ax4.legend()
